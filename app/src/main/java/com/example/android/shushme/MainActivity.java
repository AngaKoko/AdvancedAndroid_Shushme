...
public class MainActivity extends AppCompatActivity implements
    ...
    public void onResume() {
        ...
        //DoneTODO (3) Initialize ringer permissions checkbox
        CheckBox ringerPermission = (CheckBox) findViewById(R.id.ringer_permission_checkbox);
        NotificationManager nm = (NotificationManager) getSystemService(NOTIFICATION_SERVICE);
        // Check if the API supports such permission change and check if permission is granted
        if(Build.VERSION.SDK_INT >= 24 && nm.isNotificationPolicyAccessGranted()==false){
            ringerPermission.setChecked(false);
            Toast toast = Toast.makeText(getApplicationContext(), "Hmm!", Toast.LENGTH_SHORT);
            toast.show();
        }else{
    ...
    // DoneTODO (2) Implement onRingerPermissionsClicked to launch ACTION_NOTIFICATION_POLICY_ACCESS_SETTINGS
